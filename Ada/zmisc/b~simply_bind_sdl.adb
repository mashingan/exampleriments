pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~simply_bind_sdl.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~simply_bind_sdl.adb");
...
package body ada_main is
   ...
   E06 : Short_Integer; pragma Import (Ada, E06, "interfaces__c_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_simply_bind_sdl");
...
--  BEGIN Object file/option list
   ...
   --   -L.\
   --   -Lc:/bin\
   --   -LC:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/11.2.0/adalib/
   --   -static
   --   -lgnat
   --   -Wl,--stack=0x2000000
